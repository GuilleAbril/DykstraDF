...
a_prueba = c(-1,1) # x2<=x1
A_prueba = matrix(a_prueba, nrow = 1, ncol = 2, byrow = TRUE)
dykstra_linealBall(x0 = c(3,-3), A = A_prueba, b = 0)

Aejmp = matrix(c(0,1), nrow = 1, ncol = 2)
dykstra_linealBall(c(3,0),A = Aejmp, b = -3/4)
...
#dykstra_linealBallDF(DF, A = A, b = b, I = I)
dykstra_linealBallDF(DF, A = A, b = b)
